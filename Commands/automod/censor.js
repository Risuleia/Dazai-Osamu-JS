module.exports = {
  ...
  execute: async (client, message, args, db) => {
    ...
    db.get(`censored_words_${message.guild.id}`).then(words => {
      ...
      if (args[0] === '+') {
        ...
        words.push(wordItem)
        db.set(`censored_words_${message.guild.id}`, words)
      ...
      if (args[0] === 'list') {
        ...
        const censoredWordEmbed = {
          ...
          description: words.length !== 0 ? word_list : 'No censored words in this server.\n',
          footer: {
